...
${properties}`
	...
	function Header($$anchor, $$props) {
		if (new.target) return createClassComponent({ component: Header, ...$$anchor });
		push($$props, false, Header);

		let mode = prop($$props, 'mode', 12, "cards");
		...
		html(node, () => description, false, false);
		reset(p);
		reset(div);
		append($$anchor, div);
	...
	function UnsmurfTrades($$anchor, $$props) {
		if (new.target) return createClassComponent({ component: UnsmurfTrades, ...$$anchor });
		push($$props, false, UnsmurfTrades);

		let nationId = prop($$props, 'nationId', 12);
		let openConfig = prop($$props, 'openConfig', 12);
		...
		reset(div_1);
		reset(div);
		bind_value(input, nationId);
		event('keypress', input, handleEnter);
		event('click', button, lookupNation);

		event('click', button_1, function (...$$args) {
			apply(openConfig, this, $$args, UnsmurfTrades, [48, 20]);
		});

		append($$anchor, div);
		bind_prop($$props, 'handleEnter', handleEnter);
	...
	function Config($$anchor, $$props) {
		...
		const $settingsStore = () => (
			...
			store_get(settingsStore, '$settingsStore', $$stores)
		);

		const binding_group = [];
		let showConfig = prop($$props, 'showConfig', 12, false);
		let closeConfig = prop($$props, 'closeConfig', 12);
		const dispatch = createEventDispatcher();
...

		{
			...
			if_block(node, ($$render) => {
				if (showConfig()) $$render(consequent);
			});
		}
	...
	let masterToPuppetsCache = null; // Reverse cache for master-to-puppet mappings
	 ...
	 */
	function tallyPuppets(masterName) {
	...
	function Spinner($$anchor, $$props) {
		if (new.target) return createClassComponent({ component: Spinner, ...$$anchor });
		push($$props, false, Spinner);

		let ringColor = prop($$props, 'ringColor', 12, "#cccccc");
		let spinnerHeadColor = prop($$props, 'spinnerHeadColor', 12, "#000000");
		...
		template_effect(() => {
			set_attribute(svg, 'style', `--tw-gradient-from: ${spinnerTailColor()}; --tw-gradient-to: ${spinnerHeadColor()}; animation-delay: ${animationDelay};`);
			set_attribute(path, 'fill', ringColor());
		});
		...
		return pop({
			...
			get spinnerHeadColor() {
				return spinnerHeadColor();
			},
			set spinnerHeadColor($$value) {
				spinnerHeadColor($$value);
				flush_sync();
			},
			get spinnerTailColor() {
				return spinnerTailColor();
			},
			set spinnerTailColor($$value) {
				spinnerTailColor($$value);
				flush_sync();
			},
			$set: update_legacy_props,
			$on: ($$event_name, $$event_cb) => add_legacy_event_listener($$props, $$event_name, $$event_cb)
	...
	function TallyTables($$anchor, $$props) {
		...
		push($$props, false, TallyTables);

		let loading = prop($$props, 'loading', 12);
		let sellTallyGifts = prop($$props, 'sellTallyGifts', 28, () => []);
		let buyTallyGifts = prop($$props, 'buyTallyGifts', 28, () => []);
		let sellTallyTrades = prop($$props, 'sellTallyTrades', 28, () => []);
		let buyTallyTrades = prop($$props, 'buyTallyTrades', 28, () => []);
		let makeTallyColumns = prop($$props, 'makeTallyColumns', 12);
		let makeTallyRows = prop($$props, 'makeTallyRows', 12);
		...
		each(
			...
			index,
			($$anchor, $$item) => {
				let title = () => get$1($$item).title;

				title();

				let data = () => get$1($$item).data;
...

				{
					...
					var alternate = ($$anchor) => {
						const expression = derived_safe_equal(() => makeTallyColumns()(data()));
						const expression_1 = derived_safe_equal(() => makeTallyRows()(data()));
		...
		return pop({
			...
			get sellTallyGifts() {
				return sellTallyGifts();
			},
			set sellTallyGifts($$value) {
				sellTallyGifts($$value);
				flush_sync();
			},
			get buyTallyGifts() {
				return buyTallyGifts();
			},
			set buyTallyGifts($$value) {
				buyTallyGifts($$value);
				flush_sync();
			},
			get sellTallyTrades() {
				return sellTallyTrades();
			},
			set sellTallyTrades($$value) {
				sellTallyTrades($$value);
				flush_sync();
			},
			get buyTallyTrades() {
				return buyTallyTrades();
			},
			set buyTallyTrades($$value) {
				buyTallyTrades($$value);
				flush_sync();
			},
			get makeTallyColumns() {
				return makeTallyColumns();
			},
			set makeTallyColumns($$value) {
				makeTallyColumns($$value);
				flush_sync();
			},
			get makeTallyRows() {
				return makeTallyRows();
			},
			set makeTallyRows($$value) {
				makeTallyRows($$value);
				flush_sync();
			},
			$set: update_legacy_props,
	...
	function DetailedTables($$anchor, $$props) {
		...
		push($$props, false, DetailedTables);

		let loading = prop($$props, 'loading', 12);
		let buys = prop($$props, 'buys', 28, () => []);
		let sells = prop($$props, 'sells', 28, () => []);
		let makeTradeColumns = prop($$props, 'makeTradeColumns', 12);
		let makeTradeRows = prop($$props, 'makeTradeRows', 12);
		let makeGiftColumns = prop($$props, 'makeGiftColumns', 12);
		let makeGiftRows = prop($$props, 'makeGiftRows', 12);
		...
		each(
			...
			($$anchor, $$item) => {
				...
				let columns = () => get$1($$item).columns;

				columns();

				let rows = () => get$1($$item).rows;
		...
		return pop({
			...
			get makeTradeColumns() {
				return makeTradeColumns();
			},
			set makeTradeColumns($$value) {
				makeTradeColumns($$value);
				flush_sync();
			},
			get makeTradeRows() {
				return makeTradeRows();
			},
			set makeTradeRows($$value) {
				makeTradeRows($$value);
				flush_sync();
			},
			get makeGiftColumns() {
				return makeGiftColumns();
			},
			set makeGiftColumns($$value) {
				makeGiftColumns($$value);
				flush_sync();
			},
			get makeGiftRows() {
				return makeGiftRows();
			},
			set makeGiftRows($$value) {
				makeGiftRows($$value);
				flush_sync();
			},
			$set: update_legacy_props,
	...
	function NationAlert($$anchor, $$props) {
		...
		const canonicalizedName = mutable_state();
		const canonicalizedMasterName = mutable_state();
		const isCTE = mutable_state();
		const isPuppet = mutable_state();
		const isMasterCte = mutable_state();
		const puppetCountSelf = mutable_state();
		const puppetCountMaster = mutable_state();
		const puppetTally = mutable_state();
		...
		legacy_pre_effect(
			() => (
				deep_read_state(nationId())
			),
			() => {
				set(canonicalizedName, canonicalizeName(nationId()));
			}
		);
		...
		legacy_pre_effect(
			...
			() => {
				set(canonicalizedMasterName, (() => {
					const info = findPuppetmaster(get$1(canonicalizedName)).master;

					return strict_equals(canonicalizeName(info), get$1(canonicalizedName)) ? "" : info;
				})());
			}
		);
		...
		legacy_pre_effect(() => (get$1(canonicalizedMasterName)), () => {
			set(isPuppet, equals(get$1(canonicalizedMasterName), "", false) ? true : false);
		});
		...
		legacy_pre_effect(
			...
			() => {
				set(isMasterCte, !isNationCurrent(get$1(canonicalizedMasterName)));
			}
		);

		legacy_pre_effect(() => (get$1(canonicalizedName)), () => {
			set(puppetCountSelf, tallyPuppets(get$1(canonicalizedName)));
		});
		...
		legacy_pre_effect(
			...
			() => {
				set(puppetCountMaster, tallyPuppets(get$1(canonicalizedMasterName)));
			}
		);
		...
		legacy_pre_effect(
			() => (
				get$1(isPuppet),
				get$1(puppetCountMaster),
				get$1(puppetCountSelf)
			),
			() => {
				set(puppetTally, get$1(isPuppet) ? get$1(puppetCountMaster) : get$1(puppetCountSelf));
			}
		);
		...
		legacy_pre_effect(
			...
			() => {
				set(formattedName, get$1(isCTE) ? "&#xe000;&#x2009;" + uncanonicalizeName(get$1(canonicalizedName)) : uncanonicalizeName(get$1(canonicalizedName)));
			}
		);
		...
		legacy_pre_effect(
			...
			() => {
				set(formattedMasterName, get$1(isMasterCte) ? "&#xe000;&#x2009;" + uncanonicalizeName(get$1(canonicalizedMasterName)) : uncanonicalizeName(get$1(canonicalizedMasterName)));
			}
		);
		...
		legacy_pre_effect(
			...
			() => {
				set(bgColor, get$1(canonicalizedName).length <= 2 ? "#00000000" : get$1(isCTE) ? "#000000FF" : "#00000000");
			}
		);
		...
		legacy_pre_effect(
			...
			() => {
				set(textColor, get$1(canonicalizedName).length <= 2 ? "#00000000" : get$1(isCTE) ? "#FFFFFF" : "#000000");
			}
		);
		...
		legacy_pre_effect(
			...
			() => {
				set(alertMessage, (() => {
					if (get$1(canonicalizedName).length <= 2) {
						return "　"; // Single CJK space
					}

					let returnValue = `<strong>${get$1(formattedName)}</strong>`;

					if (get$1(isPuppet)) {
						returnValue += ` (<strong>${get$1(formattedMasterName)}</strong>)`;
					}
	...
	function App($$anchor, $$props) {
		...
		let isMasterCte = mutable_state(false);
		...
		{
			add_owner_effect(() => get$1(nationId), UnsmurfTrades);

			UnsmurfTrades(node_1, {
				loadTradeData,
				get showConfig() {
					return get$1(showConfig);
				},
				openConfig,
				get nationId() {
					return get$1(nationId);
				},
				set nationId($$value) {
					set(nationId, $$value);
				},
		...
		TallyTables(node_4, {
			...
			get sellTallyGifts() {
				return get$1(sellTallyGifts);
			},
			get buyTallyGifts() {
				return get$1(buyTallyGifts);
			},
			get sellTallyTrades() {
				return get$1(sellTallyTrades);
			},
			get buyTallyTrades() {
				return get$1(buyTallyTrades);
			},
			makeTallyColumns,
			makeTallyRows
		});
