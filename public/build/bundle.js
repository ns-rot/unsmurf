...
var app = (function () {
	...
	function UnsmurfTrades($$anchor, $$props) {
		...
		let redirectToPage = prop($$props, 'redirectToPage', 12);
		...
		event('click', button, function (...$$args) {
			apply(redirectToPage, this, $$args, UnsmurfTrades, [41, 20]);
		});

		event('click', button_1, function (...$$args) {
			apply(openConfig, this, $$args, UnsmurfTrades, [49, 20]);
		});
	...
	var root$1 = add_locations(template(`<div class="mx-[-0.375rem] sm:mx-[-1rem] md:mx-[-1.5rem] lg:mx-[-2rem] xl:mx-[-6%] font-inter text-xl py-4 mt-4 mb-2 transition-all duration-200 min-h-[3rem]" role="alert"><div class="w-[80%] mx-auto text-center"><!></div></div>`), NationAlert[FILENAME], [[49, 2, [[54, 4]]]]);
	...
	function NationAlert($$anchor, $$props) {
		...
		legacy_pre_effect(
			...
			() => {
				set(formattedName, isCTE() ? "&#xe000;&#x2009;" + uncanonicalizeName(canonicalizedName()) : uncanonicalizeName(canonicalizedName()));
			}
		);
		...
		legacy_pre_effect(
			...
			() => {
				set(formattedMasterName, isCTE() ? "&#xe000;&#x2009;" + uncanonicalizeName(canonicalizedMasterName()) : uncanonicalizeName(canonicalizedMasterName()));
			}
		);
